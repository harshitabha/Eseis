var c1 = false;
var codes =[]; //maybe add secret codes here

document.addEventListener("DOMContentLoaded", function() {
    
    document.getElementsByTagName('form')[0].onsubmit = function(evt) {
        evt.preventDefault(); //prevent the form from submitting
        checkWord(true); //check for basic choices    PROBLEM IS HERE
        window.scrollTo(0, 150);
        if(start) { 
            checkWord(); }//run the story
        window.scrollTo(0, 150);
    }
    var start = false; //to check if the story has started
    ...
    var add = function(textToAdd, type = "") {
        // if output is related to the story
        if(type=="story") { document.getElementById('terminalResultsCont').innerHTML += "<p class='story'>" + textToAdd + "</p>"; }

        // if the output in the terminal are instructions
        else if(type=="dir") { document.getElementById('terminalResultsCont').innerHTML += "<p class='dir'>" + textToAdd + "</p>"; }
    ...
    var postHelpList = function() {
        var helpKeyWords = [ // ADD HERE
            ...
            "- 'google' + search term will search Google for the entered term",
            "- 'youtube' + search term will search youtube for the entered term",
            "- 'open' + url will open the given url",
    ...
    var textReplies = function() {
        switch(textInputVal) {
            ...
            case "youtube":
                clearInput();
                add("Type youtube + something to search for.", "dir");
                break;

            case "google":
                clearInput();
                add("Type google + something to search for.", "dir");
                break;
            ...
            // clear the terminal of all the text
            case "CLEAR":
                clearInput();
            ...
            case "s":
                ...
                directions();
                start = true;
                add("Your adventure will begin now", "dir");
                break;
            
            // //only if story has started
            // if(story)
            // {
            //     //if choice one has been made
            //     if(!c1)
            //     {
            //         if(textInputVal === "a")
    ...
    //this function will give starting directions for the game
    var directions = function() {
        add("Before your adventure begins here is a key of the different types of text you will see throughout the story", "dir");
        add("If the text appears in this light salmon color please pay close attention to what it says" + 
        " These are important directions to progress in using the terminal", "dir");
        add("If the text appears in this light blue color it is relavant to what is occurring in the story", "story");
        add("Any white colored text like this will be text you enter");
    };

    // Main function to check the entered text and assign it to the correct function
    var checkWord = function(check = false) {
        textInputVal = document.getElementById('terminalTextInput').value.trim(); // to get the entered text 
        //only if something was entered
        if(check && textInputVal != "")
        {
    ...
    var runStory = function()
    {
        ...
        add("Make your choice (type A or B). <br>Option A: Stay back<br>Option B: Run to the door", "story");
        ...
        //                     a while they found out that their father had died, spending time to atone for their own self pity. <br>World End. Restart?", "story");//AAA
        //             }
        //             else if(choiceb) //No.
        //             {
        //                 add("\“No…\” Said Vesper.\
        ...
        //                 but his child did not open the door.\¨ Vesper cried even harder.<br>A month later Vesper stood behind the front door.", "story");//AAB
        ...
        //                     environment.<br> The peaceful ending.<br> World End. Restart?", "story");//AABA
        //                 }
        ...
        //                         house as to avoid conflict in case Vesper came back in the future. Which they later did but that’s another story.<br>World End. Restart?", "story");//AABBA
        //                     }
        ...
        //                         adventure the world.<br>Leaving in good heart!<br> World End. Restart?", "story");//AABBB
        //                     }
        //                 }
        //             }
        ...
        //             eventually dying three days later.<br> World End. Restart?", "story");//AB
        //         }
        //         }
        ...
        //                         this become your strength.  <br>If everything has happened as predicted, then there is nothing holding you back. You can choose to stay \
        ...
        //     }
        // }*/
        if(textInputVal == "work") { add("ran!", "story"); }
    };
